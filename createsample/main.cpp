...
int main(int argc, char* argv[]) {
	...
	char* vecname	 = NULL;	/* .vec filename */
	char* infoname	 = NULL;	/* file name with marked up image description */
	...
	int width = 24;
	int height = 24;
	bool pngoutput = false;	/* wheter to make the samples in png or in jpg */
